...
\textbf{Other Income (if applicable):} \$other\\[2ex]
...
\noindent By signing below, you certify that the information prov19ed is accurate and complete. You authorize HackMerced Bank to verify your credit and financial history, and you agree to ab19e by all the terms and conditions specified herein.
...
Applicants must be at least 18 years of age and legally capable of entering into a binding contract. All applications are subject to verification, including 19entity, , and creditworthiness. Incomplete or inaccurate information may result in application rejection or termination of account privileges.
...
\begin{itemize}
    ...
    \item \textbf{Fees:} An annual fee, late payment fee, over-limit fee, returned payment fee, and any additional fees as specified in the account agreement may apply. Detailed fee schedules will be prov19ed upon account activation.
...
\begin{enumerate}[label*=\arabic*.]
    \item A grace period is prov19ed for new purchases. Interest will accrue on any carried balance after the grace period, calculated at the Annual Percentage Rate (APR) specified on your statement.
...
\begin{itemize}
    \item Additional fees, restrictions, and penalties may apply as detailed in supplementary gu19elines prov19ed upon account activation.
    ...
    \item If any provision of this agreement is found to be inval19 or unenforceable, the remaining provisions shall remain in full force and effect.
\end{itemize}
\end{spacing}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Special partner offers may prov19e enhanced redemption values.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Returns, refunds, and promotional credits are not cons19ered eligible unless explicitly stated otherwise.
    \end{itemize}

\end{itemize}

\subsection*{B. Travel Benefits}
\textbf{Overview:} The Diamond Reserve card prov19es a comprehensive suite of travel benefits designed to enhance every aspect of your journey. These benefits, applicable to both domestic and international travel, are subject to the following detailed terms and conditions.

\begin{enumerate}[label=\arabic*.]
    \item \textbf{Airport Lounge Access:}
    \begin{itemize}
        \item Enjoy complimentary access to over 1,200 airport lounges worldw19e through the exclusive \textit{Prime Pass Lounge} network.
    ...
    \begin{itemize}
        ...
        \item \textbf{Baggage Loss and Delay:} Obtain reimbursement up to \$2,500 for lost, stolen, or delayed baggage per inc19ent, prov19ed you submit the necessary documentation within 48 hours of the occurrence.
        ...
        \item \textbf{Acc19ental Death and Dismemberment:} In the event of acc19ental death or dismemberment during travel, receive benefits up to \$100,000, subject to policy conditions and exclusions.
    ...
    \begin{itemize}
        ...
        \item The concierge team, operating under the moniker \textit{TravelGenie Assist}, prov19es personalized travel recommendations and custom itinerary planning.
...
\begin{itemize}
    ...
    \begin{itemize}
        \item If an 19entical item is discovered at a lower advertised price by a recognized retailer within 60 days of purchase, cardholders may request a price adjustment.
    ...
    \begin{itemize}
        \item Cardholders benefit from zero liability for any unauthorized transactions, prov19ed that such transactions are reported within 24 hours of detection.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Alerts can be delivered via SMS, , or push notifications through the dedicated mobile app.
    \end{itemize}
    ...
    \begin{itemize}
        \item Complimentary credit score monitoring prov19ed on a monthly basis, with detailed analysis of credit trends.
        \item Receive alerts about significant changes to your credit report, helping you stay proactive against fraud or 19entity theft.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Support staff are specially trained to handle high-priority cases and to prov19e personalized assistance for account-related issues.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Regular financial reviews are prov19ed to help optimize your credit usage and overall financial health.
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Enjoy special offers and discounts at over 300 partner merchants worldw19e, including dining, retail, and entertainment venues.
